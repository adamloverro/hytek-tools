...
def parse_mi_report_pdf(pdf_path):
    swimmers = []
    ...
    for page in pdf.pages:
        ...
        for line in lines:
            ...
            # PDF reports produced by hytek sometimes incorrectly encode the letter 'f' as 'ϐ'
            ...
            if '(' in line and ')' in line and ',' in line and ('M' in line or 'F' in line):
                ...
                # Add the current swimmer name to the list of swimmers
    ...
    print(f"Number of Swimmers Processed: {len(swimmers)}")
    return df
...
for pdf_path in pdf_files:
    ...
    parsed_df = parse_mi_report_pdf(pdf_path)
    ...
    # Remove records that have a time improvement of zero
